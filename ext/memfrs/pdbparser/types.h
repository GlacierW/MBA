...
//typedef struct SLF_FIELDLIST_SUBSTRUCT{
//        void* data;
//        struct SLF_FIELDLIST_SUBSTRUCT *prev; /* needed for a doubly-linked list only */
//        struct SLF_FIELDLIST_SUBSTRUCT *next; 
//} SLF_FIELDLIST_SUBSTRUCT;
...
typedef struct {
    ...
    ctor_f *copy;
    dtor_f *dtor;
} UT_SLF_FIELDLIST_SUBSTRUCT;

typedef struct SLF_FIELDLIST{
	//SLF_FIELDLIST_SUBSTRUCT *substructs;
        UT_array *substructs;
} SLF_FIELDLIST;
